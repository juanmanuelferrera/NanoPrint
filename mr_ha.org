...
### 1. DPI Optimization
- Calculate page dimensions based on target DPI
- Calculate total area needed = page_count × page_area + gaps
- **Resize SVG shapes** to accommodate the required area
- Place pages optimally within the resized SVG area difference
